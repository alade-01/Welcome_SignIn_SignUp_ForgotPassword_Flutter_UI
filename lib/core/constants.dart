...
Map<int, Color> color0 = {
  ...
  200: const Color.fromRGBO(31, 65, 187, .3),
  300: const Color.fromRGBO(31, 65, 187, .4),
  400: const Color.fromRGBO(31, 65, 187, .5),
  500: const Color.fromRGBO(31, 65, 187, .6),
  600: const Color.fromRGBO(31, 65, 187, .7),
  700: const Color.fromRGBO(31, 65, 187, .8),
  800: const Color.fromRGBO(31, 65, 187, .9),
...
final List<Map<String, dynamic>> WEIGHT_RANGE = [
  {
    "title": "Jusqu’a 200 g",
    "checked": false,
    "value": "UP_TO_200_G",
  ...
  {
    "title": "De 500 g à 1 kg",
    "checked": false,
    "value": "FROM_500_G_TO_1_KG",
  },
  {
    "title": "De 1 kg à 2 kg",
    "checked": false,
    "value": "FROM_1_KG_TO_2_KG",
  },
  {
    "title": "De 2 kg à 5 kg",
    "checked": false,
    "value": "FROM_2_KG_TO_5_KG",
  },
  {
    "title": "De 5 kg à 10 kg",
    "checked": false,
    "value": "FROM_5_KG_TO_10_KG",
  },
  {
    "title": "De 10 kg à 30 kg",
    "checked": false,
    "value": "FROM_10_KG_TO_30_KG",
  },
];

final List<Map<String, dynamic>> STATE_ARTICLE = [
  {
    "title": "État neuf avec emballage",
    "subTitle":
        "Le jouet est neuf encore dans son emballage d'origine, jamais ouvert",
    "checked": false,
    "value": "BRAND_NEW_CONDITION_WITH_PACKAGING",
  },
  {
    "title": "État neuf sans emballage",
    "subTitle":
        "Le jouet est neuf, jamais utilisé sans son emballage d'origine",
    "checked": false,
    "value": "NEW_CONDITION_WITHOUT_PACKAGING"
  },
  {
    "title": "Très bon état",
    "subTitle":
        "Le jouet est très peu utilisé et peut avoir de légères imperfections mais il reste en très bon état, Précise les défauts avec des  photos et une description détaillé. ",
    "checked": false,
    "value": "VERY_GOOD_CONDITION",
  },
  {
    "title": "Bon état",
    "subTitle":
        "Le jouet à utilisé quelques fois et a quelques imperfectionsn et quelquessigne d'usures. Précise  les défauts avec des photos et une description détaillée.",
    "checked": false,
  ...
  /*{
      "title": "État moyen",
      "subTitle":
          "Le jouet à utilisé plusieurs fois et a des imperfectionset des signes d'usures. "
              "Précise les défauts avec des photos et une description d'étaillée.",
      "checked": false,
      "value :"AVERAGE_CONDITION"   }*/
];

final List<dynamic> AGES_RANGE = [
  {"id": "MOIS_0_6", "items": [], "image": "", "title": "0 - 6 mois"},
  {"id": "MOIS_6_12", "items": [], "image": "", "title": "6 - 12 mois"},
  {"id": "ANS_1_2", "items": [], "image": "", "title": "1 an - 2 ans"},
  {"id": "ANS_2_3", "items": [], "image": "", "title": "2 ans - 3 ans"},
  {"id": "ANS_3_4", "items": [], "image": "", "title": "3 ans - 4 ans"},
  {"id": "ANS_4_5", "items": [], "image": "", "title": "4 ans - 5 ans"},
  {"id": "ANS_5_6", "items": [], "image": "", "title": "5 ans - 6 ans"},
  {"id": "ANS_6_7", "items": [], "image": "", "title": "6 ans - 7 ans"},
  {"id": "ANS_7_8", "items": [], "image": "", "title": "7 ans - 8 ans"},
  {"id": "ANS_8_12", "items": [], "image": "", "title": "8 ans - 12 ans"},
  {"id": "ANS_12_16", "items": [], "image": "", "title": "12 ans - 16 ans"}
];
